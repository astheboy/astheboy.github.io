...
- Improve line numbered code block styling when using `{% highlight <lang> [linenos] %}` tag. [#513](https://github.com/mmistakes/minimal-mistakes/issues/513)
- Add English fallback to "Follow" button label. [#496](https://github.com/mmistakes/minimal-mistakes/pull/496)

### Bug Fixes

- Fix Firefox alignment issues with code blocks generated with the `{% highlight <lang> [linenos] %}` tag. [#512](https://github.com/mmistakes/minimal-mistakes/issues/512)
...
- Add `{% highlight <lang> [linenos] %}` code block examples to demo site.

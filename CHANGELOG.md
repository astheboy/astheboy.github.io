...
- Fix Firefox alignment issues with code blocks generated with the `{% highlight ruby %}` tag. [#512](https://github.com/mmistakes/minimal-mistakes/issues/512)
...
- Add `{% highlight ruby %}` code block examples to demo site.

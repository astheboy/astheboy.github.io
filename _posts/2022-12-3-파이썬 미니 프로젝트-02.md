...
if conditions["direction"][i] == answer : #딕셔너리의 리스트 값 중에 무작위로 선택된 내용과 사용자가 선택한 값이 맞는지 확인
...
```
    ...
    랜덤 선택 게임입니다. 당신의 선택은?
    당신은 왼쪽을 선택했군요. 길이 끊겼습니다. 게임을 종료합니다.
